    ...
    <aside className="w-64 bg-black text-white p-4 min-h-screen">
      ...
      {role === "admin" && (
        <nav className="space-y-2">
          ...
          <NavLink to="/manage-bookings" className={linkClass}>Bookings</NavLink>
      ...
      {role === "staff" && (
        <nav className="space-y-2">
          <NavLink to="/staff/dashboard" className={linkClass}>Staff Dashboard</NavLink>
          <NavLink to="/staff/bookings" className={linkClass}>Bookings</NavLink>
        </nav>
      )}
      ...
      {role === "customer" && (
        <nav className="space-y-2">
          ...
          <NavLink to="/projects" className={linkClass}>My Projects</NavLink>
